...
const DICT = {
    ...
    'Удалить это сообщение? Оно уйдёт и из истории чата.': 'Delete this message? It will also be removed from the chat history.',
    'Сообщение удалено': 'Message deleted', 'Не нашла это сообщение в истории': 'Could not find this message in the history',
    'Сообщение не найдено — история изменилась': 'Message not found — the history has changed',
    'Каналы': 'Channels', 'Мой канал': 'My channel', 'Подписки': 'Subscriptions', 'Можно подписаться': 'You can subscribe',
    'Завести свой канал': 'Start your own channel', 'Найти каналы': 'Find channels', 'Свежие посты': 'Fresh posts',
    'Удалить канал': 'Delete the channel', 'Убрать канал': 'Remove the channel', 'Обсуждение': 'Discussion', 'Обсудить': 'Discuss',
    'обсуждение выключено': 'discussion is off', 'Ещё комментарии': 'More comments', 'Написать в канал…': 'Post to the channel…',
    'Написать в обсуждение…': 'Write in the discussion…', 'Подписать…': 'Add a note…', 'Отправить в лс': 'Send as a DM',
    'Подписаться': 'Subscribe', 'Отписаться': 'Unsubscribe', 'Ответить': 'Reply', 'Нарисовать по описанию': 'Draw from the text',
    'Приложить фото': 'Attach a photo', 'Выключить обсуждение': 'Turn the discussion off', 'Включить обсуждение': 'Turn the discussion on',
    'Удалить пост': 'Delete the post', 'Канал создан': 'Channel created', 'Подписка оформлена': 'Subscribed', 'Отписались': 'Unsubscribed',
    'Обсуждение включено': 'Discussion is on', 'Обсуждение выключено': 'Discussion is off', 'Пустой пост': 'Empty post',
    'поста нет в телефоне': 'the post is not on the phone', 'скрин': 'screenshot', 'твиттер': 'Twitter', 'инстаграм': 'Instagram',
    'сторис': 'story', 'канал': 'channel', 'Как назовём канал?': 'What should the channel be called?',
    'О чём он? (одной строкой)': 'What is it about? (one line)', 'Назови канал': 'Give the channel a name',
    'Сначала заведи канал': 'Start a channel first', 'Сначала заведи контакты': 'Add some contacts first',
    'Удалить свой канал вместе со всеми постами?': 'Delete your channel along with all of its posts?',
    'Удалить пост из канала?': 'Delete this post from the channel?',
    'Сначала напиши текст поста — по нему и рисуем': 'Write the post text first — the picture follows it',
    'Каналов не нашлось — попробуй ещё раз': 'No channels found — try again',
    'Канал молчит — попробуй ещё раз': 'The channel is quiet — try again',
    'Обсуждение молчит — попробуй ещё раз': 'The discussion is quiet — try again',
    'Подписчики молчат — реакции не пришли': 'Subscribers are quiet — no reactions arrived',
    'Нажми поиск — модель соберёт каналы': 'Tap search — the model will collect channels', 'этого города и мира': 'of this city and world',
    'Напиши первый пост — подписчики': 'Write the first post — subscribers', 'отреагируют сами': 'will react on their own',
    'Нажми ↻ — канал наполнится': 'Tap ↻ — the channel will fill up', 'Пока тихо. Напиши первой': 'Quiet so far. Write the first one',
    'или нажми ↻': 'or tap ↻',
