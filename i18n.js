...
const DICT = {
    ...
    'Сбросить кнопку': 'Reset button', 'Отчёт: последние действия': 'Report: recent activity', 'Работа': 'Work', 'Вакансии': 'Job openings', 'Задания': 'Tasks', 'Другие объявления': 'Other openings', 'Где работала раньше': 'Previous jobs', 'Отработать смену': 'Work a shift', 'Просить повышение': 'Ask for a promotion', 'Уволиться': 'Quit', 'Откликнуться': 'Apply', 'Свежие объявления': 'Fresh openings', 'Убрать участника': 'Remove member', 'Убрать': 'Remove', 'Нарисовать товар': 'Draw the item', 'Фото товара готово': 'Item photo ready', 'Смена отработана': 'Shift done', 'Повышение!': 'Promoted!', 'Отказали': 'Refused', 'Ты уволилась': 'You quit', 'Выше расти некуда.': 'Top of the ladder.', 'можно просить': 'you can ask', 'смен': 'shifts', 'в месяц': 'per month', 'Экран с системной панелью (сдвинуть телефон)': 'Screen with a system bar (shift the phone)', 'Перегенерировать пост': 'Regenerate post', 'Пересобрать ленту заново': 'Rebuild the feed', 'Дописать в ленту': 'Add to the feed', 'Пост переписан': 'Post rewritten', 'Не получилось переписать пост': 'Could not rewrite the post', 'Остановить генерацию': 'Stop generating', 'Остановить': 'Stop', 'Генерация остановлена': 'Generation stopped', 'Очистить телефон в этом чате': 'Wipe the phone in this chat', 'Сброс к заводским настройкам': 'Factory reset', 'Данные телефона в этом чате стёрты': 'Phone data in this chat wiped', 'Сброшено к заводским настройкам': 'Reset to factory settings', 'Отчёт скопирован в буфер': 'Report copied to clipboard', 'Сбросить настройки': 'Reset settings', 'Убрать из истории': 'Remove from history',
