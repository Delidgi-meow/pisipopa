...
const DICT = {
    ...
    'Сбросить кнопку': 'Reset button', 'Отчёт: последние действия': 'Report: recent activity', 'Только мой промпт (без служебных приписок)': 'My prompt only (no service notes)', 'Остановить генерацию': 'Stop generating', 'Остановить': 'Stop', 'Генерация остановлена': 'Generation stopped', 'Очистить телефон в этом чате': 'Wipe the phone in this chat', 'Сброс к заводским настройкам': 'Factory reset', 'Данные телефона в этом чате стёрты': 'Phone data in this chat wiped', 'Сброшено к заводским настройкам': 'Reset to factory settings', 'Отчёт скопирован в буфер': 'Report copied to clipboard', 'Сбросить настройки': 'Reset settings', 'Убрать из истории': 'Remove from history',
